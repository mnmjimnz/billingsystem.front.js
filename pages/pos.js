                ...
                <div class="row g-2 align-items-center">
                    <div class="col-5">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="number" class="form-control text-center" value="${item.quantity}" min="1" oninput="updateQty(${index}, this.value)">
                        </div>
                    </div>
                    <div class="col-7 text-end fw-bold text-primary" id="item-subtotal-${index}">
